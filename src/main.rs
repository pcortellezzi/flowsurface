...
use exchanges::{
    ...
    adapter::{Event as ExchangeEvent, Exchange, StreamError, StreamType, binance, bybit, rithmic},
};
use iced::{
                ...
                let fetch_tasks = {
                    Exchange::MARKET_TYPES
                        ...
                        .map(|(exchange, market_type)| match exchange {
                            ...
                            Exchange::Rithmic => fetch_ticker_prices(
                                *exchange,
                                rithmic::fetch_ticker_prices(*market_type),
                            ),
                        })
                        .collect::<Vec<Task<Message>>>()
                };
